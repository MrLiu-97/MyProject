...
// Type: dangdangSDK.Util.HttpItem
...
namespace dangdangSDK.Util
{
    public class HttpItem
    {
        ...
        private Encoding _Encoding = (Encoding)null;
        private PostDataType _PostDataType = PostDataType.String;
        private string _Postdata = string.Empty;
        private byte[] _PostdataByte = (byte[])null;
        private CookieCollection cookiecollection = (CookieCollection)null;
